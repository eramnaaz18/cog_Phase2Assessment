...
describe('ProductAddComponent', () => {
  ...
  it('should render the page title',()=>{
    let comp = component.pageTitle = "Add Product";
    fixture.detectChanges();
  ...
  it('should bind name to FormControl',()=>{
    const name = fixture.debugElement.query(By.css('#name'));
    const comp = component.addProduct.get("name");
  ...
  it('should bind brand to FormControl',()=>{
    const brand = fixture.debugElement.query(By.css('#brand'));
    const comp = component.addProduct.get("brand");
  ...
  it('should bind price to FormControl',()=>{
    const price = fixture.debugElement.query(By.css('#price'));
    const comp = component.addProduct.get("price");
    comp?.setValue(22500);
    fixture.detectChanges();
  ...
  it('should bind rating to FormControl',()=>{
    const rating = fixture.debugElement.query(By.css('#rating'));
    const comp = component.addProduct.get("rating");
  ...
  it('should bind the first category value on selection of dropdown list',() => {
    ...
    fixture.detectChanges();
    expect(select.value).toEqual('clothing');
  }); 

  it('should mark category as invalid if left unselected', ()=>{
    const comp = component.addProduct.get("category");
    comp?.setValue(null);
    fixture.detectChanges();
    expect(comp?.invalid).toBeTruthy();
  });
  ...
  it('should bind image to FormControl',()=>{
    const image = fixture.debugElement.query(By.css('#image'));
    const comp = component.addProduct.get("image");
  ...
  it('should bind seller to FormControl',()=>{
    const seller = fixture.debugElement.query(By.css('#seller'));
    const comp = component.addProduct.get("seller");
  ...
  it('should call the saveProduct form action when Save Product button is clicked', ()=>{
    const submit = fixture.debugElement.query(By.css('.addProduct-form'));
    const func = spyOn(component,'saveProduct');
  ...
  it('should return true is form is valid', ()=>{
    ...
    component.addProduct.patchValue(dummyData);
    fixture.detectChanges();
    expect(component.addProduct.valid).toBeTrue();
    let saveBtn =   fixture.debugElement.query(By.css('#submit')).nativeElement;
    expect(saveBtn.disabled).toBe(false);
  });


  //testing the routing of addProduct to Product-list component
  it('should take back to products list page on click of Save Product button', ()=>{
  ...
  it('should check Save Product button is disabled initially', () => {
    fixture.detectChanges();
    let saveBtn =   fixture.debugElement.query(By.css('#submit')).nativeElement;
